...
import org.demo.footballresource.mongo.repository.MongoTeam1Repository;
...
@Service
public class MongoTeam1Service {

    private final MongoTeam1Repository teamRepository;
    ...
    public MongoPlayer1Dto getPlayer(String id) {
